...
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(3)
    await typew.edit("**Halo.Salam kenal Gua Kyy**")
    sleep(3)
    await typew.edit("**Umur 19 tahun**")
    sleep(1)
    await typew.edit("**Asal Batam**")
    sleep(4)
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("**NAMANYA JUGA JAMET CAPER SANA SINI BUAT CARI NAMA MODAL SOKAPIN ORANG 1 PER 1 KONTOL!!**")
...
@register(outgoing=True, pattern=r"^\.sokap(?: |$)(.*)")
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(
        "**SOKAP BET LU GOBLOK, KAGA ADA ISTILAH NYA BAWAHAN TEMENAN AMA BOS!!**"
    )
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(
        "**GAK KEREN LO KEK BEGITU GOBLOK, KELUARGA LU BAWA SINI GUA LUDAHIN SATU-SATU. CUIHH KONTOL!!!**"
    )
...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit(
        "**DIHHH NAJISS ANAK HARAM LO GOBLOK, JANGAN BELAGU DIMARI KAGA KEREN LU KEK BGITU TOLOL! DI REAL LIFE BEBAN KELUARGA DI TELEGRAM JADI SAMPAH TOLOL!!**"
    )
...
CMD_HELP.update(
    {
        ...
        \n\n**Klo mau Req, kosa kata dari lu Hubungi @sokapgblg**\
    "
    }
)
